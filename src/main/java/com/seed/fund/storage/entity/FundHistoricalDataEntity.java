...
public class FundHistoricalDataEntity {
    ...
    public FundHistoricalDataEntity(Long id, FundMetaDataEntity metaData, BigDecimal numberOfShares, Integer numberOfInvestors, BigDecimal totalValue, BigDecimal price, LocalDate valueDate) {
        this.id = id;
